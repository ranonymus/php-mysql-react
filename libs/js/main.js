var CreateProductComponent = React.createClass({
	...
	componentDidMount: function() {
		this.serverRequest = $.get("helper/read_all_categories.php", function (categories) {
			this.setState({
	...
	onSave: function(e){
		$.post("helper/create_product.php", {
...
var UpdateProductComponent = React.createClass({
	...
	componentDidMount: function() {
		this.serverRequestCat = $.get("helper/read_all_categories.php", function (categories) {
			this.setState({
				categories: JSON.parse(categories)
			});
		}.bind(this));
		...
		this.serverRequestProd = $.post("helper/read_one_product.php",
			{prod_id: productId},
			function (product) {
	...
	onSave: function(e){
		$.post("helper/update_product.php", {
				id: this.state.id,
				name: this.state.name,
				description: this.state.description,
				price: this.state.price,
...
var DeleteProductComponent = React.createClass({
    ...
    onDelete: function(e){
        ...
        $.post("helper/delete_products.php",
            { del_ids: [productId] },
            function(res){
...
var ReadProductsComponent = React.createClass({
    ...
    componentDidMount: function() {
        this.serverRequest = $.get("helper/read_all_products.php", function (products) {
            this.setState({
